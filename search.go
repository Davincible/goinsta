...
func (sb *Search) History() (*[]SearchHistory, error) {
	...
	if err := sb.NullState(); err != nil {
		...
		sb.insta.warnHandler("Non fatal error while setting search null state: " + err.Error())
	}
	return h, nil
}
...
func (sb *Search) search(query string, fn func(string) (*SearchResult, error)) (*SearchResult, error) {
	...
	if err := sb.NullState(); err != nil {
		...
		insta.warnHandler("Non fatal error while setting search null state: " + err.Error())
	}
